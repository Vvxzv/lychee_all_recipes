...
public interface BaseRecipeSchema {
    RecipeKey<Post[]> POST_ACTION = LycheeSchema.POST_ARRAY.key("post").optional(new Post[]{});
    RecipeKey<Contextual[]> CONTEXTUAL_CONDITION = LycheeSchema.CONTEXTUAL_ARRAY.key("contextual").optional(new Contextual[]{});
